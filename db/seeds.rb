...
books = [
    ...
    { title: "The Bible", author: "Many", isbn: "0000000001", condition: -3 },
...
hagen.books.create(books[0])
hagen.books.create(books[1])

hendrik = User.create(user_name: "hendrik", password: "test", email: "hbergunde@gmx.de", age: 27, description: "The author of this piece of software")
hendrik.books.create(books[2])
hendrik.books.create(books[3])
hendrik.books.create(books[4])

tina = User.create(user_name: "tina", password: "blar", email: "tinchen@blaaar.xox", age: 22, description: "no one actually knows me.")
tina.books.create(books[5])
tina.books.create(books[6])
